<html>
    ...
    <body>
        ...
        <div class="grid-container">
                ...
                <div class="grid-x grid-margin-x">
                    <div class="small-12 medium-12 large-12 cell form-container-center">
                        <button class="button button_red button-padding button_standartWidth font_bold font_white" type="submit" value="Submit">Ваша заявка откланена</button>
                    </div>
                </div>   
