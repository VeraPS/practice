...
DROP DATABASE IF EXISTS `practice_dvfu2`;
...
-- Дамп данных таблицы practice_dvfu2.call_status: ~8 rows (приблизительно)
...
-- Дамп данных таблицы practice_dvfu2.coach: ~1 rows (приблизительно)
DELETE FROM `coach`;
...
-- Дамп данных таблицы practice_dvfu2.concern: ~7 rows (приблизительно)
DELETE FROM `concern`;
...
-- Дамп данных таблицы practice_dvfu2.groups_dvfu_db: ~4 rows (приблизительно)
...
-- Дамп данных таблицы practice_dvfu2.students: ~4 rows (приблизительно)
...
-- Дамп данных таблицы practice_dvfu2.students_dvfu_db: ~3 rows (приблизительно)
...
-- Дамп данных таблицы practice_dvfu2.users_dvfu_db: ~10 rows (приблизительно)
