...
-- Дамп структуры базы данных practice_dvfu
DROP DATABASE IF EXISTS `practice_dvfu`;
CREATE DATABASE IF NOT EXISTS `practice_dvfu` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `practice_dvfu`;
...
-- Дамп данных таблицы practice_dvfu.call_status: ~8 rows (приблизительно)
...
-- Дамп данных таблицы practice_dvfu.coach: ~1 rows (приблизительно)
DELETE FROM `coach`;
...
-- Дамп данных таблицы practice_dvfu.concern: ~7 rows (приблизительно)
DELETE FROM `concern`;
...
INSERT INTO `groups_dvfu_db` (`id_group`, `number`, `title`, `id_coach`) VALUES
	(1, 'Б8419а', 'Прикладная информатика в дизайне', 14),
	(2, 'Б8119а', 'Прикладная информатика в дизайне', 14),
	(3, 'Б8419б', 'Прикладная Информатика в экономике ', 14),
	(4, 'Б8119б', 'Прикладная информатика в экономике', 14);
...
-- Дамп данных таблицы practice_dvfu.students_dvfu_db: ~3 rows (приблизительно)
...
-- Дамп данных таблицы practice_dvfu.users_dvfu_db: ~10 rows (приблизительно)
...
-- Дамп данных таблицы practice_dvfu.vacancy: ~7 rows (приблизительно)
DELETE FROM `vacancy`;
...
INSERT INTO `vacancy` (`id`, `id_conc`, `title`, `description`, `conditions`, `address`, `term_of_practice`) VALUES
	...
	(3, 6, 'Охранник', 'Примечания 1', 'Требования 1', 'Адрес 1', NULL),
	(4, 6, 'Погромист', '', '', '', NULL),
	(5, 6, 'Менеджер торгового зала', 'Подойдёт почти любой', 'Знание компьютерного железа', 'ДНС на Алеутской', NULL),
	(6, 6, 'Насяльника', 'лолшто', 'Ничего не нужно', 'Где угодно', NULL),
	(7, 5, 'Учитель физкультуры', 'Платят мало но стабильно', 'Физ форма', 'Школа номер 6', NULL);
