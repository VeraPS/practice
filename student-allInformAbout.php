<html>
    ...
    <body>
        ...
        <div class="grid-container">
                ...
                <div class="grid-x grid-margin-x">
                    <div class="small-12 medium-12 large-12 cell form-title form-title_blue form-title_underline">Программист PHP</div>
                </div>
                ...
                <div class="grid-x grid-margin-x">
                    <div class="small-12 medium-5 large-5 cell">
                        <button class="button button_green button-padding font_bold font_white" type="submit" value="Submit">Принять</button>
                    </div>

                    <div class="small-12 medium-5 medium-offset-2 large-5 large-offset-2 cell">
                        <button class="button button_red button-padding font_bold font_white" type="submit" value="Submit">Отклонить</button>
                    </div>
                </div>   
